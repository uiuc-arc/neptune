    ...
    def __init__(
        ...
        if value is None:
            self.__init_handle_by_constructor__(
                _ffi_api.PrimStructInfoFromDtype,
                dtype,
                span,  # type: ignore
            )
        else:
            self.__init_handle_by_constructor__(
                _ffi_api.PrimStructInfoFromValue,
                value,
                span,  # type: ignore
            )
...
class TensorStructInfo(StructInfo):
    ...
    def __init__(
        self,
        shape: Expr | Sequence[int | PrimExpr] | None = None,
        dtype: str = "float32",
        vdevice: VDevice | str | None = None,
        ndim: int = -1,
        span: Span | None = None,
    ) -> None:
...
class TupleStructInfo(StructInfo):
    ...
    def __init__(self, fields: list[StructInfo], span: Span | None = None) -> None:
